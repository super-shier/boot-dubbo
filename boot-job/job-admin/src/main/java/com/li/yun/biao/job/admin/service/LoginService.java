...
import com.li.yun.biao.job.admin.core.util.CookieUtil;
import com.li.yun.biao.job.admin.core.util.I18nUtil;
import com.li.yun.biao.job.admin.core.util.JacksonUtil;
import com.li.yun.biao.job.admin.dao.JobUserDao;
 ...
 * @description job log for glue, used to track job code process
 */
@Configuration
