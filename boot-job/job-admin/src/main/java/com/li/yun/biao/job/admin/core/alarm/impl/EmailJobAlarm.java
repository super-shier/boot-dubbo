package com.li.yun.biao.job.admin.core.alarm.impl;

import com.li.yun.biao.job.admin.core.alarm.JobAlarm;
 ...
 * @description job alarm by email
 */
@Component
    ...
    public boolean doAlarm(JobInfo info, JobLog jobLog) {
        ...
        if (info != null && info.getAlarmEmail() != null && info.getAlarmEmail().trim().length() > 0) {
            ...
            for (String email : emailSet) {
                ...
                // make mail
                try {
                    MimeMessage mimeMessage = JobAdminConfig.getAdminConfig().getJavaMailSender().createMimeMessage();
                    ...
                    JobAdminConfig.getAdminConfig().getJavaMailSender().send(mimeMessage);
                } catch (Exception e) {
